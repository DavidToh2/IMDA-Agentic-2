...
supervisor = AssistantAgent(
    name = "Supervisor",
    system_message=f"""Supervisor. You are to remind the next member of the team to search for {speaker}.""",
    llm_config={"config_list": config_list, "cache_seed": None},
)
...
writer = AssistantAgent(
    ...
    If the information is provided by internal search, preface your profile with the headline "INTERNAL SEARCH"
    If the information is provided by external search, preface your profile with the headline "EXTERNAL SEARCH"
...
summariser = AssistantAgent(
    ...
    Preface your profile with "PROFILE: {speaker}". 
    """,
)

post_internal_message("LOG STARTING...")
